...
print("export interface CodeSize {")
print("  prefix: string;")
print("  type: string;")
print("  name: string;")
print("  hs: number;")
...
print("export interface MatterCodeSize extends CodeSize {")
print("  hs: number;")
print("  fs: number | null;")
print("  ss: number;")
print("  xs: number;")
...
print("export interface IndexerCodeSize extends CodeSize {")
print("  hs: number;")
print("  fs: number | null;")
print("  ss: number;")
print("  os: number;")
...
print("export interface CounterCodeSize extends CodeSize {")
print("  hs: number;")
print("  fs: number;")
print("  ss: number;")
print("}")
