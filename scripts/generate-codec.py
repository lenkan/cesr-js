...
print(f"export const MatterSchemeTable = {format_hards(Matter.Hards)}")
print(f"export const CountTable_10 = {format_size(Counter.Sizes.get(1).get(0))}")
print(f"export const CountSchemeTable = {format_hards(Counter.Hards)}")
...
print(f"export const IndexSchemeTable = {format_hards(Indexer.Hards)}")
