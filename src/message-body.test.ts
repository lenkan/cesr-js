...
describe("Message version properties", () => {
...
describe("Encode version string via Message constructor", () => {
...
describe("Parse message via Message.parseBody", () => {
...
test("Should handle different protocol names", () => {
  ...
  assert.ok((message.payload.v as string).startsWith("ACDC"));
});
